...
export default () => (<svg class="calligraphy" xmlns="http://www.w3.org/2000/svg"
  ...
  <g clipPath="url(#re-kata-clip-path)">
    <path class="siblings" stroke-width="30px" d="M54.59,28,60.8,154.51l20.34-5.35,30-16.21A145.29,145.29,0,0,0,170,70.35" />
  </g>
</svg>)