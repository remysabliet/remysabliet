...
export default ({ className, firstStrokeClassName }) =>
  <svg className={classNames('calligraphy', className)}
    ...
    <g clipPath="url(#hi-clip-path)">
      ...
      <line className="siblings alphabet" strokeWidth="11" x1="80.63" y1="31.5" x2="81.63" y2="42.5" />
