...
export default ({ className, firstStrokeClassName }) =>
  <svg class={classNames('calligraphy', className)}
    ...
    <g clip-path="url(#let-clip-path)">
      <polyline class={classNames('siblings alphabet', firstStrokeClassName)} stroke-width="11" points="31 5 17 43 8 73 6 88 9.5 92.5 39.5 87.5 48.5 84.5 53.5 84.5" />
      <path class="siblings alphabet" stroke-width="8" d="M61,74l7.5-3.5L71,71c.52-4,1.82-5.43,3-6s2.31-.15,4-1a8,8,0,0,0,3-3c4.19-6,7.5-6.08,8-10,0-.38.39-3-1-4-.9-.64-2.6-.63-7,2a47.52,47.52,0,0,0-11,9C61.2,68.32,56.79,73.48,57,81c0,1.74.21,7.81,4,11,6.22,5.24,20.82,1.54,35-11" />
      <path class="siblings alphabet" stroke-width="9" d="M136,17v7l-4,10-5,10-8,15a70.44,70.44,0,0,0-4.5,9.5c-2.17,5.64-3.52,9.29-3,14,.28,2.55.64,5.73,3,8,2.73,2.62,8.73,2,13,1,3.36-.79,5.1-1.35,7-4a11.65,11.65,0,0,0,2-5" />
      <polyline class="siblings alphabet" stroke-width="9" points="100.5 56.5 109.5 51.5 116.5 50.5 136.5 48.5 145.5 48.5" />
