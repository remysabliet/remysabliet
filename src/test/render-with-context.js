...
export default function renderWithContext(
  ...
  Neanmoins dans le cas du challenge6, en regardant le code *render-app.js*, quoi qu’il arrive, renderWithCOntext() sera toujours invoque avec un objet qui est soit vide {} dans le cas ou l’utilisateur ne specifie pas de route, soit enrichi de la valeur *{route:route}* en parametre, donc dans notre cas on pourrait retirer la partie speciale  *= {}* definit en parametre de la fonction renderWithCOntext().
 */
) {
  return {
